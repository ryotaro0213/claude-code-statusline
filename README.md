...
```bash
git clone https://github.com/ryotaro0213/claude-code-statusline-.git ~/.claude/statusline
...
```powershell
git clone https://github.com/ryotaro0213/claude-code-statusline-.git $env:USERPROFILE\.claude\statusline
